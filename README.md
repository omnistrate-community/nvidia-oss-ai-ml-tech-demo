...
```bash
omctl build -f spec.yaml --name 'NVIDIA Platform Demo' --spec-type ServicePlanSpec --release-as-preferred
```

### 3. Use the auto-generated Self-Service Portal to deploy your AI/ML platform

#### Deploy the TAO Training Service
1. Navigate to the Self-Service Portal.
2. Select the "NVIDIA Platform Demo" service you created.
3. Choose the "TAO Training Service" from the list of available services.
4. Configure the service parameters as needed.
5. Click "Create" to launch the service.

![Deploy TAO Training Service](deploy-tao-training.png)

#### Access the Inference Service APIs
1. Navigate to the instance details and access the API from the connectivity section
2. Use the included Swagger API to play with the service

![TAO Swagger API](tao-swagger.png)
![TAO Swagger API Experiments](tao-swagger-experiments.png)

#### Deploy the full AI platform (training and inference pipeline)
1. Navigate to the Self-Service Portal.
2. Select the "NVIDIA Platform Demo" service you created.
3. Choose the "AI Platform Cluster" from the list of available services.
4. Configure the service parameters as needed.
5. Click "Create" to launch the service.

![Deploy AI Platform](deploy-ai-platform.png)
